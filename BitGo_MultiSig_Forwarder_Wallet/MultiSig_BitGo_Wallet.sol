...
contract WalletSimple {
  ...
  function sendMultiSig(
    ...
    function getHash( address toAddress, uint value, bytes data, uint expireTime, uint sequenceId)public constant returns(bytes32){
        return keccak256("ETHER", toAddress, value, data, expireTime, sequenceId);
    }
  /**
